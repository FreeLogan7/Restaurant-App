...
public class StarterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView startersList = findViewById(R.id.list_view_starter);



        Dish[] dishes = {
                new Dish("Mushroom and tofu maki"," Toasted Seaweed",999),
        ...
        ArrayAdapter<Dish> dishesAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, dishes); //this is context
